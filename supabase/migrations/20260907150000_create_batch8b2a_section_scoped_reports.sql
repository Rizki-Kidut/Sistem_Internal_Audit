...
-- Strongest relationship first: an existing LTP/CAR Section.
...
) UPDATE public.findings f SET seksi_auditee_id=s.seksi_id FROM scoped s WHERE f.instruction_row_id=s.row_id AND f.seksi_auditee_id IS NULL;
