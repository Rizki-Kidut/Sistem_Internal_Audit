...
export const LTP_STATUS_LABEL:Record<LtpStatus,string> = {
  ...
  AUDITOR_REVIEW:'Menunggu Verifikasi Auditor', AUDITOR_RETURNED:'Dikembalikan ke Auditor', ADMIN_REVIEW:'Menunggu Keputusan Admin/QMS', CLOSED:'Closed',
};
...
export const KODE_DOKUMEN_LAPORAN_INTERNAL_AUDIT = 'Q-120-ISE-001-FORM-015';
