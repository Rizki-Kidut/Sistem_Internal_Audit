...
export interface AuditExecutionFindingSummary { id: string; source_item_id: string; kode_temuan: string | null; draft_reference: string; kategori: KategoriTemuan; plor_complete: boolean; disposition: FindingSourceDisposition | null; }
...
export interface FindingSourceDisposition { initial_judgement:string;effective_judgement:string;reason:string;actor_display_name:string;created_at:string; }
