...
const emptyItem = (phaseId: string): ChecklistProdukItem => ({
  ...
  jumlah_sampel: null, hasil_pemeriksaan: null, judgment: null,
  urutan_tampil: 0, created_at: '', updated_at: '',
});
